...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'black-hole-button': `Because you got <b>${format('ee300000')}</b> ${toTextStyle('Fish', 'fish')}, you need to form a black hole in case you enter another universe.`,
        ...
        'forge': {
            ...
            'wormhole': ['Wormhole',`Unlocks new Particle Accelerators.`],
        ...
        'particle-accel-boost': [
            x => `Increase the ${toTextStyle('Fish', 'fish')} production by <b>${x}</b>.`,
            x => `Multiply the previous particle accelerator's effect by <b>${x}</b>.`,
            x => `Multiply ${toTextStyle('Prestige','prestige')} shards' gain by <b>${x}</b>.`,
            x => `Power the third particle accelerator's effect by <b>${x}</b>.`,
            x => `Power the second particle accelerator's effect by <b>${x}</b>.`,
            x => `Multiply the fifth particle accelerator's effect by <b>${x}</b>.`,
            x => `Multiply the fourth particle accelerator's effect by <b>${x}</b>.`,
            x => `Add <b>${x}</b> to the exponent of ${toTextStyle('Prestige','prestige')} shards.`,
            x => `Multiply the sixth particle accelerator's effect by <b>${x}</b>.`,
            x => `Multiply the ninth particle accelerator's effect by <b>${x}</b>.`,
            x => `Tetrate ${toTextStyle('Remnant','black-hole')} gain by <b>${x}</b>.`,
            x => `Power the first particle accelerator by <b>${x}</b>.`,
        ],
        ...
        'progress-4-text': r => `Reach ${format(r)} total ${toTextStyle('Prestige','prestige')} shards to unlock the ${toTextStyle('Core','core')}`,
        ...
        get 'reset-black-hole-message'() {
            ...
            Forming the ${e} resets everything ${c} does, as well as shark rank, humanoid sharks, evolution tree, sharkoid faith, evolution goals, cultivation, forge, you keep particle accelerators, some research, some automations, and some feature progress for a new ${e}.
